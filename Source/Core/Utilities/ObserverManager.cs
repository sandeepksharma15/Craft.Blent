...
/// </remarks>
internal class ObserverManager<TIdentity, TObserver>(ILogger log)
    : IEnumerable<TObserver> where TIdentity : notnull
{
    ...
    /// An observer entry.
    /// </summary>
    private class ObserverEntry(TObserver observer)
    {
        /// <summary>
